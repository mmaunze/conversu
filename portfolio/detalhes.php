              ...
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <div class="portfolio-links">
                    <a href="<?php echo htmlspecialchars($portfolio['capa']); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?php echo htmlspecialchars($portfolio['titulo']); ?>"><i class="bx bx-plus"></i></a>
                    <a href="detalhes.php?portfolio=<?php echo htmlspecialchars($portfolio['id']); ?>" class="portfolio-details-lightbox" data-glightbox="type: external" title="<?php echo "Detalhes de " . htmlspecialchars($portfolio['titulo']); ?>"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            </div>
